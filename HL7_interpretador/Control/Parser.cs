...
namespace HL7_interpretador.Control
{
    class Parser
    {
        ...
        public bool Parse_ORM_O01(string mensaje, string version)
        {
            ...
            PreAdmision pa = new PreAdmision();
                    ...
                    for (int i = 0; i < mensaje.Length; i++)
                    {
                        ...
                        switch (segmento[0])
                        {
                            ...
                            case "PID":
                                ...
                                break;
                            case "PV1":
                                orm_o01.PV1 = new string[segmento.Length];
                                orm_o01.PV1 = segmento;
                                break;
                            case "IN1":
                                orm_o01.IN1 = new string[segmento.Length];
                            ...
                            case "OBR":
                                ...
                                break;
                            case "OBX":
                                orm_o01.OBX = new string[segmento.Length];
                                orm_o01.OBX = segmento;
                                break;
                        }
                        if (orm_o01.OBX.Length > 0)
                        {
                            break;
                        }
                    }

                    if (orm_o01.MSH.Length <= 0 || orm_o01.PID.Length <= 0 || orm_o01.PV1.Length <= 0 || orm_o01.IN1.Length <= 0 || orm_o01.ORC.Length <= 0 || orm_o01.OBX.Length <= 0 || orm_o01.OBR.Length <= 0)
                    {
                        correcto = false;
                    }
        ...
        public bool Parse_ADT_A08(string mensaje, string version)
        {
            ...
            if (correcto)
            {
                registro.ActualizarPaciente(adt_a08);
                return correcto;
            }
            else
            {
